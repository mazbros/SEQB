...
namespace SEQB
{
    ...
    public class ListViewExtender : IDisposable
    {
        ...
        public ListViewExtender(ListView listView)
        {
            ...
            Font = new Font(ListView.Font.FontFamily, ListView.Font.Size + 1, ListView.Font.Style & FontStyle.Bold);
        }
    ...
    public class ListViewButtonColumn : ListViewColumn
    {
        ...
        public ListViewButtonColumn(int columnIndex, bool drawIfEmpty)
            : base(columnIndex)
        {
            DrawIfEmpty = drawIfEmpty;
        }

        public bool FixedWidth { private get; set; }
        private bool DrawIfEmpty { get; }
